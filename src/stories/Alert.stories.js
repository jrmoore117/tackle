...
AlertRed.args = {
   ...
   action: <Icon as="X" color="red" variant="clickable" size="xl" className="p-1" />,
};
...
AlertYellow.args = {
   ...
   action: <Icon as="X" color="yellow" variant="clickable" size="xl" className="p-1" />,
};
...
AlertGreen.args = {
   ...
   action: <Icon as="X" color="green" variant="clickable" size="xl" className="p-1" />,
};
...
AlertPurple.args = {
   ...
   action: <Icon as="X" color="purple" variant="clickable" size="xl" className="p-1" />,
};
...
AlertIndigo.args = {
   ...
   action: <Icon as="X" color="indigo" variant="clickable" size="xl" className="p-1" />,
};
