...
export const DefaultTabs = () => {
  ...
  return (
    <Tabs index={index} onClick={setIndex}>
      <Tab tabTitle="Profile">Profile Settings</Tab>
      <Tab tabTitle="Notifications">Notifications Settings</Tab>
      <Tab tabTitle="Security">Security Settings</Tab>
    </Tabs>
  );
};
...
export const TabsWithAddNewTab = () => {
  ...
  return (
    <Tabs
      index={index}
      onClick={setIndex}
      newTab={<Tab tabTitle="New Tab">This is a new tab.</Tab>}
    >
      <Tab tabTitle="Tab 1">Tab 1</Tab>
    </Tabs>
  );
};
