...
AlertYellow.args = {
  ...
  action: (
    <Icon as="X" color="yellow" variant="clickable" size={6} padding={1} />
  ),
};
...
AlertGreen.args = {
  ...
  action: (
    <Icon as="X" color="green" variant="clickable" size={6} padding={1} />
  ),
};
...
AlertPurple.args = {
  ...
  action: (
    <Icon as="X" color="purple" variant="clickable" size={6} padding={1} />
  ),
};
...
AlertIndigo.args = {
  ...
  action: (
    <Icon as="X" color="indigo" variant="clickable" size={6} padding={1} />
  ),
};
